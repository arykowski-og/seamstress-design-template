...
export const dataVizPalette: DataVizColor[] = [
  {
    name: 'Blurple',
    token: 'blurple/500',
    value: capitalDesignTokens.foundations.colors.blurple500,
  ...
  },
  {
    ...
    value: capitalDesignTokens.foundations.colors.terracotta500,
  ...
  },
  {
    name: 'Purple',
    token: 'purple/600',
    value: capitalDesignTokens.foundations.colors.purple600,
  ...
  },
  {
    name: 'Turquoise',
    token: 'turquoise/500',
    value: capitalDesignTokens.foundations.colors.turquoise500,
  ...
  },
  {
    name: 'Magenta',
    token: 'magenta/A200',
    value: capitalDesignTokens.foundations.colors.magenta500,
  ...
  },
  {
    name: 'Blue',
    token: 'blue/600',
    value: capitalDesignTokens.foundations.colors.blue600,
  ...
  },
  {
    name: 'Red',
    token: 'red/600',
    value: capitalDesignTokens.foundations.colors.red600,
  ...
  },
  {
    name: 'Violet',
    token: 'violet/500',
    value: capitalDesignTokens.foundations.colors.violet500,
  ...
  },
  {
    name: 'Green',
    token: 'green/500',
    value: capitalDesignTokens.foundations.colors.green500,
  ...
  },
  {
    name: 'Yellow',
    token: 'yellow/500',
    value: capitalDesignTokens.foundations.colors.yellow500,
  ...
  },
  {
    name: 'Blurple Dark',
    token: 'blurple/600',
    value: capitalDesignTokens.foundations.colors.blurple600,
  ...
  },
  {
    name: 'Orange',
    token: 'orange/600',
    value: capitalDesignTokens.foundations.colors.orange600,
  ...
  },
  {
    name: 'Purple Light',
    token: 'purple/500',
    value: capitalDesignTokens.foundations.colors.purple500,
  ...
  },
  {
    name: 'Turquoise Dark',
    token: 'turquoise/600',
    value: capitalDesignTokens.foundations.colors.turquoise600,
  ...
  },
  {
    name: 'Magenta Dark',
    token: 'magenta/700',
    value: capitalDesignTokens.foundations.colors.magenta700,
  ...
  },
  {
    name: 'Blue Dark',
    token: 'blue/700',
    value: capitalDesignTokens.foundations.colors.blue700,
  ...
  },
  {
    name: 'Orange Light',
    token: 'orange/500',
    value: capitalDesignTokens.foundations.colors.orange500,
  ...
  },
  {
    name: 'Violet Dark',
    token: 'violet/600',
    value: capitalDesignTokens.foundations.colors.violet600,
  ...
  },
  {
    name: 'Green Dark',
    token: 'green/600',
    value: capitalDesignTokens.foundations.colors.green600,
  ...
  },
  {
    name: 'Yellow Dark',
    token: 'yellow/600',
    value: capitalDesignTokens.foundations.colors.yellow600,
