              ...
              <LinearProgress
                ...
                sx={{
                  ...
                  '& .MuiLinearProgress-bar': {
                    borderRadius: 1,
                    background: 'linear-gradient(90deg, #0D7377 0%, #14AFAF 50%, #2BC5C5 100%)',
                  },
                }}
              />
            </Box>
  ...
  return (
    <Box sx={pageStyles.formView.pageContainer}>
      ...
      >
        ...
        {/* Workspace Section */}
        <Typography variant="h2" fontWeight={700} sx={{ mb: 2 }} id="workspace-section">
          Workspace
        </Typography>
        ...
        >
          <Typography variant="h2" fontWeight={700} id="workflows-heading">
            Workflows In Progress
          </Typography>
        ...
        >
          <Typography variant="h2" fontWeight={700} id="sessions-heading">
            Sessions
          </Typography>
