...
export const getWorkOrdersByStatus = () => {
  ...
  return [
    { name: 'Open', value: statusCounts.open || 0, fill: '#3b82f6' },
    { name: 'Scheduled', value: statusCounts.scheduled || 0, fill: '#6366f1' },
    { name: 'In Progress', value: statusCounts.in_progress || 0, fill: '#8b5cf6' },
...
export const getWorkOrdersByPriority = () => {
  ...
  return [
    ...
    { name: 'Urgent', value: priorityCounts.urgent || 0, fill: '#dc2626' }
  ];
};
