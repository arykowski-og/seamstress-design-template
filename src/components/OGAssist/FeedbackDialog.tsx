...
export const FeedbackDialog: React.FC<FeedbackDialogProps> = ({
  ...
  const iconColor = feedbackType === 'positive' ? '#16a34a' : '#dc2626';
            ...
            <Rating
              ...
              sx={{
                '& .MuiRating-iconFilled': {
                  color: feedbackType === 'positive' ? '#16a34a' : '#eab308',
                },
              }}
            />
          </Box>
      ...
      <DialogActions sx={{ px: 3, pb: 3 }}>
        ...
        <Button
          ...
          sx={{
            bgcolor: iconColor,
            '&:hover': {
              bgcolor: feedbackType === 'positive' ? '#15803d' : '#b91c1c',
            },
          }}
        >
          Submit Feedback
  ...
  return (
    <Box
      sx={{
        ...
        zIndex: 9999,
        border: '1px solid',
        borderColor: type === 'positive' ? '#16a34a' : '#dc2626',
      }}
    >
      {type === 'positive' ? (
