...
export const CommunityMetrics: React.FC<CommunityMetricsProps> = ({
  ...
  const statusData = [
    { name: 'Passed', value: metrics.totalPassed, color: '#4caf50' },
    { name: 'Failed', value: metrics.totalFailed, color: '#f44336' },
    { name: 'Pending', value: metrics.totalPending, color: '#ff9800' },
    { name: 'Cancelled', value: metrics.totalCancelled, color: '#9e9e9e' },
  ];
